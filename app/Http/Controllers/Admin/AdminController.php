...
class AdminController extends Controller
{
    ...
    public function memberslistindex(){
        if (Gate::denies('developerOnly') && Gate::denies('admin.list')) {
            return back();
        }
    ...
    public function loantypelistindex(){
        // $data = collect();
        if (Gate::denies('developerOnly') && Gate::denies('admin.home')) {
            return back();
        }
        return view('admin.loan-type.list');
    }

    public function loanlistindex(){
        if (Gate::denies('developerOnly') && Gate::denies('admin.list')) {
            return back();
        }
    ...
    public function agencylistindex(){
        if (Gate::denies('developerOnly') && Gate::denies('admin.list')) {
            return back();
        }

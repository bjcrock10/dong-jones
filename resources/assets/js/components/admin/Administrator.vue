<template>
                    ...
                    <table class="responsive-table bordered">
                        ...
                        <tbody v-if="componentData.length">
                            <tr v-for="runningData in componentData">
                                ...
                                <td v-text="runningData.signaturekey"></td>
                                <td>
    ...
    <div id="componentDataModal" class="modal modal-fixed-footer large">
        <div class="modal-content">
            <div class="col s12">
                <h5>{{pupupMod | capitalize}} BANG</h5>
            </div>
            <form @submit.prevent="isNotValidateForm" name="callback" class="col s12">
                ...
                <div class="input-field">
                    <input type="text" id="admin-signaturekey" name="signaturekey" v-model="singleObj.signaturekey">
                    <label for="admin-signaturekey">Signature-Key</label>
                </div>
                <div class="input-field">
...
export default {
    ...
    data() {
        return {
            singleObj: { id: Number, name: String, email: String, status: String, inrole: '', designation: String, signaturekey: String },
            pupupMod: 'add',
            showAdd: false,
            gridColumns: ['name', 'email', 'role', 'designation', 'status','signaturekey', 'action'],
    ...
    methods: {
        resetSingleObj() {
            this.singleObj = { id: "", name: "", email: "", designation:"" ,status: "", inrole: "", signaturekey: "" };
